...
//    private long lastFrame;
    ...
    public Bricks() {
      ...
      brickAnimation.getKeyFrames().add(new KeyFrame(new Duration(15), new EventHandler<ActionEvent>() {
      @Override
...
//        lastFrame=thisFrame;
        ...
        double tslf = thisRun.toSeconds()-lastRun.toSeconds();
    ...
    private void prepareLevel() {
        for(int i = 0; i<10; i++) {
            Brick b = new Brick(1, 60, 10, 2+62*i, 50);
            bricks.add(b);
